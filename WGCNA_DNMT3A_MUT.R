...
# blast count needs to go in model in DE calling as well 
...
setwd("/data/sfb1/groups/A07/AML_triplets/RNA_Seq/")
...
anno<-readRDS("/data/sfb1/groups/A07/AML_triplets/RNA_Seq/AnnoAndCounts/anno_CN.rds")
counts<-readRDS("/data/sfb1/groups/A07/AML_triplets/RNA_Seq/AnnoAndCounts/counts_CN.rds")
...
# we need the res table only for filtering out lowy expressed genes!
...
saveRDS(sft,file="/data/htp/A07/AML_triplets/RNA_Seq/WGCNA/sft_DNMT3A_MUT.rds")
...
saveRDS(adjacency,file="/data/htp/A07/AML_triplets/RNA_Seq/WGCNA/adjacency_DNMT3A_MUT.rds") 
...
saveRDS(TOM,file="/data/htp/A07/AML_triplets/RNA_Seq/WGCNA/tom_DNMT3A_MUT.rds") 
